...
export const addProject = async (slug, user_id) => {
  try {
    const { data } = await supabase.from('projects').insert([{ slug, created_by: user_id }]).select()
    return data
  } catch (error) {
    console.log('error', error)
  }
...
export const updateProject = async (config, user_id) => {
  try {
    const { data } = await supabase.from('projects').update([{ config, created_by: user_id }]).select()
    return data
  } catch (error) {
    console.log('error', error)
  }
...
export const addLayer = async (layer, project_id, user_id) => {
  try {
    const { data } = await supabase.from('layers').insert([{ layer, project_id, user_id }]).select()
    return data
  } catch (error) {
    console.log('error', error)
  }
...
export const deleteProject = async (project_id) => {
  try {
    const { data } = await supabase.from('projects').delete().match({ id: project_id })
    return data
  } catch (error) {
    console.log('error', error)
  }
...
export const deleteLayer = async (layer_id) => {
  try {
    const { data } = await supabase.from('layers').delete().match({ id: layer_id })
    return data
  } catch (error) {
    console.log('error', error)
  }
