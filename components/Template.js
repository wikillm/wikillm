...
const uiSchema = {
  'ui:order': ['name', 'each', 'question', 'hasLoop', "loop", 'hasOverrides', 'objective','context', 'type', 'pattern', 'hasChildren', 'children'],
...
/> */}
      <Form
        ...
        templates={{ ButtonTemplates: { AddButton }, ArrayFieldTitleTemplate, TitleFieldTemplate }}
        uiSchema={{
          template: {
